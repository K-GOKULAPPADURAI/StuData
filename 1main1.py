...
class StudentDetailsApp:
    def __init__(self, root):
        ...
        self.background_images = {
            "STUDENT BASIC DETAILS": PhotoImage(file="backgrounds/pic1.png"),
            "FAMILY DETAIL": PhotoImage(file="backgrounds/pic2.png"),
            "ACADEMIC DETAIL": PhotoImage(file="backgrounds/pic3.png"),
            "SCHOLARSHIP DETAILS": PhotoImage(file="backgrounds/pic4.png"),
            "CERTIFICATE DETAILS": PhotoImage(file="backgrounds/pic5.png"),
            "BANK DETAILS": PhotoImage(file="backgrounds/pic6.png"),
            "SEARCH STUDENT": PhotoImage(file="backgrounds/pic7.png"),
            "UPLOAD EXCEL": PhotoImage(file="backgrounds/pic1.png"),
            "EXPORT EXCEL": PhotoImage(file="backgrounds/pic2.png")
        }
    ...
    def create_main_page(self):
        ...
        for label_text in labels:
            ...
            self.set_background_image(frame, label_text)
...
##                self.create_export_excel_window(frame)
    ...
    def set_background_image(self, frame, label_text):
        # Create a canvas to display the background image
        canvas = tk.Canvas(frame, width=800, height=600)  # Adjust the width and height as needed
        canvas.pack(fill="both", expand=True)

        # Set the background image as a PhotoImage
        background_image = self.background_images[label_text]
        canvas.create_image(0, 0, anchor="nw", image=background_image)

        # Bring the canvas to the back of all widgets
        canvas.lower()  
